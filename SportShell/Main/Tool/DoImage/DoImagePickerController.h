...
#define DO_MENU_BACK_COLOR          DO_RGBA(160, 175, 232, 0.98)
#define DO_SIDE_BUTTON_COLOR        DO_RGBA(160, 175, 232, 0.9)

#define DO_ALBUM_NAME_TEXT_COLOR    DO_RGB(160, 175, 232)
#define DO_ALBUM_COUNT_TEXT_COLOR   DO_RGB(219, 45, 56)
